            ...
            <div class="card-body">
                <form action="{{ route('iva.libro_compras.store') }}" method="post" id="observacionForm2">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-2 mb-12">
                            <label for="excentas_internas" class="form-label"><strong>NIT (opcional)</strong></label>
                            <input type="number" step="1" class="form-control" id="nit" name="nit" placeholder="Ingresar">
                        </div>
                        <div class="col-md-6 mt-2 mb-12">
                            <label for="excentas_importaciones" class="form-label"><strong>DUI (opcional)</strong></label>
                            <input type="number" step="1" class="form-control" id="dui" name="dui" placeholder="Ingresar">
                        </div>
                        <div class="col-md-6 mt-2 mb-12">
                            <label for="gravadas_internas" class="form-label"><strong>NRC (opcional)</strong></label>
