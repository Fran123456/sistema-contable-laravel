                ...
                <form action="{{ route('iva.libro_compras.update', $libroCompra) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mt-2 mb-12">
                            ...
                            <input type="number" step="1" class="form-control" id="nit" name="nit" value="{{ $libroCompra->nit }}">
                        </div>
                        <div class="col-md-6 mt-2 mb-12">
                            <label for="excentas_importaciones" class="form-label">DUI</label>
                            <input type="number" step="1" class="form-control" id="dui" name="dui" value="{{ $libroCompra->dui }}">
                        </div>
                        <div class="col-md-6 mt-2 mb-12">
                            <label for="gravadas_internas" class="form-label">NRC</label>
                            <input type="number" step="1" class="form-control" id="nrc" name="nrc" value="{{ $libroCompra->nrc }}">
                        </div>
                        <div class="col-md-6 mt-2 mb-12">
