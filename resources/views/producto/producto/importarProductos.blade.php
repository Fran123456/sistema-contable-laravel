...
@section('content')
    ...
    {{-- <h5 class="alert alert-info"><b>Importante:</b> Para poder realizar un ingreso de productos por medio de la importación
    ...
    <div class="alert alert-dismissible bg-light-primary d-flex flex-column flex-sm-row p-5 mb-1">
        ...
        <div class="d-flex flex-column pe-0 pe-sm-10">
            ...
            <!--begin::Content-->
            <span>Para poder realizar un ingreso de productos por medio de la importación
                vía Excel, descargue la plantilla proporcionada y llenela en base a lo que se le solicita y luego suba la plantilla
                correctamente llena en su respectivo apartado. <b>No modifique las cabeceras de la plantilla proporcionada</b></span>
            <!--end::Content-->
        </div>
    </div>
    @include('sessions')

    <a href="{{ asset('/producto/descargar-plantilla-excel') }}" class="btn btn-success mb-5"><i class="fas fa-download"></i> Descargar plantilla</a>
    <form action="{{ route('producto.importarProductosStore') }}" method="POST" enctype="multipart/form-data">
        @csrf
