...
@section('content')
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <a href="{{ route('productoproductos.create') }}" class="btn btn-primary">
            Agregar producto
        </a>
        <a href="{{ route('producto.importarProductosExcel') }}" class="btn btn-success">Importar productos vía
            Excel</a>
    </div>
