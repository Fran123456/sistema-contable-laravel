                ...
                <form action="{{ route('socios.cliente.index') }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-2 mb-12">
                            ...
                            <textarea name="direccion" class="form-control" style="height: 90px"></textarea>
                        </div>
                        <div class="col-md-4 mt-2 mb-12">
                        ...
                        <div class="col-md-4 mt-2 mb-12">
                            ...
                            <select id="actividad_economica" name="actividad_economica" class="form-control select2">
                                ...
                                @foreach ($actividadesEconomicas as $actividad)
                                    <option value="{{ $actividad->codigo }}">{{ $actividad->valor }}</option>
                                @endforeach
                            </select>
                        </div>
                        <div>
                            {{-- Obtenemos el id del usuario --}}
                            <input type="hidden" name="usuario_creo_id" value="{{ $usuario_creo->id }}"
                                class="form-control">
                        </div>
                        <div>
                            <input type="hidden" name="empresa_id"
                                value="{{ $usuario_creo->empresa_id }}"class="form-control">
                        </div>
