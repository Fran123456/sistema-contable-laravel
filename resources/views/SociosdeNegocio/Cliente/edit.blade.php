                ...
                <form action="{{route('socios.cliente.update', $cliente) }}" method="post">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mt-2 mb-12">
                            ...
                            <input type="text" name="apellido" value="{{$cliente->apellido}}" required class="form-control">
                            @error('apellido')
                                {{$message}}
                            @enderror
                        </div>
                        <div class="col-md-4 mt-2 mb-12">
                            ...
                            <input type="text" name="nit" value="{{$cliente->nit}}" required class="form-control">
                            @error('nit')
                                {{$message}}
                            @enderror
                        </div>
                        <div class="col-md-4 mt-2 mb-12">
                            ...
                            <input type="text" name="dui" value="{{$cliente->dui}}" required class="form-control">
                            @error('dui')
                                {{$message}}
                            @enderror
                        </div>
                        <div class="col-md-4 mt-2 mb-12">
                            ...
                            <input type="text" name="correo" value="{{$cliente->correo}}" required class="form-control">
                            @error('correo')
                                {{$message}}
                            @enderror
                        </div>
                        ...
                        <div class="col-md-4 mt-2 mb-12">
                            ...
                            <input type="text" name="giro_negocio" value="{{$cliente->giro_negocio}}" class="form-control">
                        </div>
                        <div class="col-md-4 mt-2 mb-12">
                        ...
                        <div class="col-md-4 mt-2 mb-12">
                            ...
                            <input type="text" name="observaciones" value="{{$cliente->observaciones}}" class="form-control">
                        </div>
                        <div class="col-md-4 mt-2 mb-12">
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $.each(data, function (key, value) {
                        ...
                        $('#departamento').append('<option value="'+ value.id +'" '+ selected +'>' + value.departamento + '</option>');
                    });
