<x-app-layout>
    ...
    <div class="col-md-12">
        <form action="{{ route('contabilidad.rubros.index') }}" method="get">
            <div class="row">
                <!-- Filtros u otros elementos de búsqueda -->
            </div>
        </form>
        <br>
    </div>
                                        ...
                                        <form action="{{ route('contabilidad.rubros.update', $rubro->id) }}" method="POST">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="number" step="0.01" class="form-control" id="saldo" name="saldo" value="{{ $rubro->saldo }}" readonly>
                                                </div>
                                            </div>
            ...
            <div class="modal-content">
                ...
                <form action="{{ route('contabilidad.rubros.store') }}" method="POST">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            <label for="saldo" class="form-label">Saldo</label>
                            <input type="number" step="0.01" class="form-control" id="saldo" name="saldo" value="0" readonly>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancelar</button>
