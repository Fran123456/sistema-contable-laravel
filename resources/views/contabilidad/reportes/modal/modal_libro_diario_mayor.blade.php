<!-- Button trigger modal -->
  ...
  <!-- Modal -->
  <div class="modal fade" id="libro_mayor" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">LIBRO DIARIO MAYOR</h5>
