<!-- Button trigger modal -->
  ...
  <!-- Modal -->
  <div class="modal fade" id="auxiliar_cuentas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">REPORTE AUXILIAR DE CUENTAS</h5>
