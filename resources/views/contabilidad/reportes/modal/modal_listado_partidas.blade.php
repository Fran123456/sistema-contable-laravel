<!-- Button trigger modal -->
  ...
  <!-- Modal -->
  <div class="modal fade" id="listado_partidas" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">LISTADO DE PARTIDAS</h5>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
           <form action="{{ route('contabilidad.listadoDePartidas') }}" method="get" target="_blank">
            <div class="row">
              <div class="col-md-12">
