...
return [
    ...
    | la clase de validación. Algunas de estas reglas tienen múltiples versiones,
    | como las reglas de tamaño. Siéntete libre de modificar cada uno de estos mensajes aquí.
    |
    */
    'whoops' => '¡Vaya! Algo salió mal.',
    'something_went_wrong' => 'Por favor, revisa los campos e intenta de nuevo.',
    ...
    */
    ...
    | en lugar de "correo". Esto simplemente nos ayuda a hacer que nuestro mensaje sea más expresivo.
    |
    */
